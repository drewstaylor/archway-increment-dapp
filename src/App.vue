...
export default {
  ...
  methods: {
    init: async function () {
      this.tendermintClient = await Tendermint34Client.connect(this.rpc);
      this.queryClient = QueryClient.withExtensions(this.tendermintClient, setupAuthExtension);
      console.log('queryClient', this.queryClient);
    },
